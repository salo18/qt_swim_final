...
export default function Terms() {
  return (
    <div className="container">
      ...
      <p>9. Governing Law: These Terms and your use of the Website shall be governed by and construed in accordance with the laws of the United States of America. Any dispute arising out of or in connection with these Terms or the Website shall be resolved in the courts of the United States of America.</p>

      <p>10. Changes to Terms: qtwateralert.co.nz reserves the right to modify these Terms at any time without notice. Your continued use of the Website following any such modification constitutes your agreement to be bound by the modified Terms.</p>

      <p>By using the qtwateralert.co.nz website, you agree to be bound by these terms and conditions. If you do not agree with any of these terms, please do not use the Website.</p>
    </div>
  );
}
